...
class Detector{
  static const String modelPath = 'Assets/ssd_mobilenet.tflite';
  ...
  final StreamController<Map<String, dynamic>> resultStream = StreamController<Map<String, dynamic>>();
  ...
  Future<void> _handleCommand(_Command command) async {
    switch (command.code) {
      ...
      // ----------------------------------------------------------------------
        ...
        _sendPort.send(_Command(_Codes.ready));
      case _Codes.detect:
        _sendPort.send(_Command(_Codes.busy));
